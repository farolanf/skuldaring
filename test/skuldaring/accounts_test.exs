defmodule Skuldaring.AccountsTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{account_id: "1", email: "some email", first_name: "some first_name", last_name: "some last_name", username: "some username", roles: []}
